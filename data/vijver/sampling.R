...
file_database = "vandeVijverBreast2002_5003x266.txt"
file_output = "vijver_p150.RData"
...
totalData = totalData[,-267];	# the last term of totalData is always NA, thus remove it
