...
uns = read.delim(file="ChenLiver2004_10237x157.txt", header = FALSE, sep = ",", nrows=1)
un0=as.numeric(uns[1]) #first n0 samples are from one class
un1=as.numeric(uns[2]) #first n1 samples are from one class
totalData = read.delim(file="ChenLiver2004_10237x157.txt", header = FALSE, sep = "\t", skip=2);
...
save( list = c("sampleNumbers" , "Data") , file="chen_p50.RData" );
