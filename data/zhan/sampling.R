...
uns = read.delim(file="ZhanMyeloma2006_54613x234.txt", header = FALSE, sep = ",", nrows=1)
un0=as.numeric(uns[1]) #first n0 samples are from one class
un1=as.numeric(uns[2]) #first n1 samples are from one class
totalData = read.delim(file="ZhanMyeloma2006_54613x234.txt", header = FALSE, sep = "\t", skip=2);
unchangedData = totalData;
totalData = totalData[,-235];
...
save( list = c("sampleNumbers" , "Data") , file="zhan_p50.RData" );
